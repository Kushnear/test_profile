(() => {
  ...
  document.addEventListener("DOMContentLoaded", async () => {
    ...
    if (profileSection) {
      try {
        const response = await axios_default2.get("http://178.250.157.107/api/user/1");
        console.log(response.data)
        profileFirstName.innerText = response.data.first_name;
        profileLastName.innerText = response.data.last_name;
        profilePicture.setAttribute("src", "http://178.250.157.107/api/"+response.data.photo);
      } catch (error) {
        console.log(error);
      }
    }
  ...
  document.addEventListener("DOMContentLoaded", async () => {
    ...
    if (inputSection) {
      ...
      inputForm.addEventListener("submit", async (e) => {
        ...
        try {
          const postResponse = await axios_default2.post("http://178.250.157.107/api/comment/create",{}, { params: post});
  ...
  document.addEventListener("DOMContentLoaded", async () => {
    ...
    if (!!postsSection) {
      try {
        const response = await axios_default2.get("http://178.250.157.107/api/comment/1");
        const userResponse = await axios_default2.get("http://178.250.157.107/api/user/1");
        console.log(response.data);
